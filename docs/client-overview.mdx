...
Once the process has been executed, the client would have to send the output back to the model as context. How that is done depends on client implementation.

<Card icon="braces" title="Example">
